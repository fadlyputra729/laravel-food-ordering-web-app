                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item active relative">
                            <a class="nav-link" href="{{ url('order') }}">
                                <div class="flex" id="navbtnorderhistory" aria-describedby="tooltiporderhistory" data-tooltip-text="History Pesanan">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        ...
                        <li class="nav-item active relative ">
                            <a class="nav-link" href="{{ url('cart') }}">
                                <div class="flex" id="navbtncart" aria-describedby="tooltipcart" data-tooltip-text="Keranjang">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
