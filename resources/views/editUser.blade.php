      ...
      <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
        <div>
          <div class="col-span-3 sm:col-span-2">
            <label for="food name" class="block text-lg font-medium text-gray-700"> Nama </label>
        ...
        <div>
          <label for="food description" class="block text-lg font-medium text-gray-700"> Username </label>
          <div class="mt-1">
            <input required id="description" value="{{$user['username']}}" name="username" type="text" class="@error('username') is-invalid @enderror resize-none p-1 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-lg border border-gray-300 rounded-md">
            @error('username')
              <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
              </span>
        ...
        <div>
          <label for="food price" class="block text-lg font-medium text-gray-700"> Alamat</label>
          <div class="mt-1 flex flex-col rounded-md">
