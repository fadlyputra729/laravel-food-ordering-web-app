    ...
    <div class="flex flex-row leading-normal border shadow-md rounded-lg max-w-3xl min-w-[50%] bg-white max-h-[96%] min-h-[50%]">
        ...
        <div class="flex flex-col p-4 h-full flex-grow">
            ...
            <div class="pt-3 flex flex-col flex-grow justify-around">
                ...
                <button id='addCartBtn' class="p-2 mt-4 bg-blue-600 hover:text-blue-600 text-neutral-50 rounded-md hover:bg-white border-2 border-blue-600 disabled:text-slate-500 disabled:bg-slate-200">Tambahkan ke Keranjang</button>
            </div>
        </div>
    </div>
</div>
