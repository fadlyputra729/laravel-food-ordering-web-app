...
@section('content')
  ...
  <div x-show="show" tabindex="0"
    ...
    <div class="z-50 relative p-3 mx-auto my-0 max-w-full" style="width: 600px;">
      <div class="bg-white rounded shadow-lg border flex flex-col overflow-hidden">
        <button
          class="closeOrderModal fill-current h-6 w-6 absolute right-0 top-0 m-6 font-3xl font-bold">&times;
        </button>
        ...
        <form method="POST" action="/cart/placeorder" class="px-4 pt-2 pb-4" name="place-order-form"
          ...
          <div class="px-6 pt-3 border-t">
            <div class="flex justify-end">
              <button type="button"
                      class="closeOrderModal bg-gray-700 text-gray-100 rounded px-4 py-2 mr-1">Close
              </Button>
  ...
  <div
    class="invisible flex h-screen overflow-y-auto overflow-x-hidden fixed right-0 left-0 top-0 z-50 justify-center items-center md:inset-0 h-modal sm:h-full"
    id="payment-modal">
    <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" aria-hidden="true"></div>
    <div class="relative px-4 w-full max-w-md h-full md:h-auto">
      <!-- Modal content -->
